...
-- SECTION 2 : LANGAGES
-- ============================================================
local langmod = dofile(vim.fs.normalize(vim.fn.stdpath("config") .. "/../language/languages.lua"))
...
do
  ...
  for _, lang in pairs(langmod.languages) do
    if lang.treesitter and not vim.tbl_contains(parsers, lang.treesitter) then
